...
export default function CryptoCoin() {
  return (
    <div className='case-main-div crypto-main-div'>
        ...
        <section className='case-section crypto-section'>
            ...
            <div className='case-flex-div-1'>
                <div>
                    <h2 className='case-h2 case-h2-crypto slide-in from-left'>Project duration: 8 weeks</h2>
                </div>
                <div>
                    <h2 className='case-h2 case-h2-crypto slide-in from-right'>Tools used: Figma, Canvas and Invision</h2>
                </div>
            </div>
            ...
            <p className='case-p fade-in'>
                ...
                People have looked for ways to buy and sell their cryptocurrencies. Crypto has carved 
            ...
            <p className='case-p fade-in'>
                ...
                also represents my app design. My final designs were based on research, inspiration and my ideas.
            </p>
            ...
            <div>
                <img src={typo} alt="case typography" className='case-typo fade-in'/>
            </div>
            ...
            <div className='final-flex'>
                <div>
                    <a href="https://www.figma.com/proto/kwxd6PoEVjnddQ3FvuQ5fO/crypto-coin?page-id=0%3A1&node-id=2%3A22&viewport=241%2C48%2C0.36&scaling=scale-down&starting-point-node-id=2%3A2" className='link-class fade-in' target="_blank"><img src={final1} alt="final design" className='final-design'/></a>
                </div>
            ...
            <div className='final-flex final-flex-last'>
                <div>
                    <a className='link-class' href="/case-study/jobfinds"><img src={others1} alt="final design" className='final-design slide-in from-left'/></a>
                </div>
                <div>
                    <a className='link-class' href="/case-study/lenis"><img src={others2} alt="final design" className='final-design slide-in from-right'/></a>
                </div>
                <div>
